    ...
    <nav id="sidebar">
        ...
        <div class="sidebar-content">
            ...
            <div class="content-side content-side-full">
                <ul class="nav-main">
                    <li>
                        <a href="{{route('blogs.dashboard')}}"><i class="si si-cup"></i><span class="sidebar-mini-hide">Dashboard</span></a>
                    </li>
                    <li>
                        <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-badge"></i><span class="sidebar-mini-hide">Blogs</span></a>
                        <ul>
                            
                                    <li>
                                        <a href="{{route('blogs.index')}}"><span class="sidebar-mini-hide">index</span></a>
                                    </li>
                                    <li>
                                        <a href="{{route('blogs.create')}}"><span class="sidebar-mini-hide">Add Blog</span></a>
                                    </li>
                                    <li>
                                        <a href="{{route('blogs.admin')}}"><span class="sidebar-mini-hide">Admin</span></a>
                                    </li>
